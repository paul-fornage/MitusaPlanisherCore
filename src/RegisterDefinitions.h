...
namespace HregAddr {
    enum HregAddr {
        ...
        HMI_COMMANDED_POSITION_REG_ADDR = 3,    // W    What position of the axis the HMI is commanding measured in hundredths of an inch.
        ...
        JOB_START_POS_REG_ADDR          = 6,    // R    The currently saved start position of the axis measured in hundredths of an inch.
